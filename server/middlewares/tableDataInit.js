...
module.exports = function() {
    return async function(ctx, next){
      const robotParamData= [
        ...
        {'id': 13,'param_name': '/uninstall_z', 'param_type': 'FLOAT', 'param_value': '0.35', 'param_class': 'ros', 'param_description': '拆卸高度'},
        ...
        {'id': 17,'param_name': '/bridgeenable', 'param_type': 'BOOL', 'param_value': 'false', 'param_class': 'ros', 'param_description': '桥架间隙是否启用'},
        {'id': 18,'param_name': '/trajectory_path/enable', 'param_type': 'BOOL', 'param_value': 'false', 'param_class': 'ros', 'param_description': '避障是否开启'},
