 ...
 * /api/task/g2tasklist:
 *   post:
 *     summary: 获取G2TaskList
 *     description: 获取G2TaskList
 *     tags:
 *       - Task
 *     parameters:
 *     responses:
 ...
 *         description: 获取失败
 */
router.post('/g2tasklist', TaskController.getG2TaskList);
/**
 * @swagger
 * /api/task/task:
 *   get:
 ...
 *         description: 获取失败
 */
router.post('/limittask', TaskController.getLimitTask);
 ...
 *         description: 获取失败
 */
router.delete('/task', TaskController.deleteMultiTask);
/**
 * @swagger
 * /api/task/taskinfo:
 *   post:
 ...
 *         description: 获取失败
 */
router.post('/limittaskinfo', TaskController.getLimitTaskInfo);
 ...
 *         description: 获取失败
 */
router.delete('/taskInfo', TaskController.deleteMultiTaskInfo);
 ...
 *         description: 获取失败
 */
router.post('/gettimedtask', TaskController.getTimedTask);
 ...
 *         description: 获取失败
 */
router.delete('/timedtask', TaskController.deleteMultiTimedTask);
